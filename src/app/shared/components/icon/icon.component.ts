  ...
  template: `
    <svg 
      ...
      <ng-container [ngSwitch]="name">
        ...
        <g *ngSwitchCase="'arrow-trending-up'">
        ...
        <g *ngSwitchCase="'arrow-trending-down'">
        ...
        <g *ngSwitchCase="'trash'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25M9 16.5v.75m3-3v3M15 13.5v.75m-12-1.5h15m-1.5-10.5l1.5 10.5"/>
        </g>
        ...
        <!-- Menu Icons -->
        <g *ngSwitchCase="'bars-3'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"/>
        </g>
        
        <g *ngSwitchCase="'x-mark'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
        </g>
        
        <!-- Chart Icons -->
        <g *ngSwitchCase="'chart-pie'">
        ...
        <g *ngSwitchCase="'presentation-chart-line'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l-1-3m1 3l-1-3m-16.5 0h16.5"/>
        </g>
        ...
        <g *ngSwitchCase="'cloud-arrow-down'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9.75v6.75m0 0l-3-3m3 3l3-3m-8.25 6a4.5 4.5 0 01-1.41-8.775 5.25 5.25 0 0110.233-2.33 3 3 0 013.758 3.848A3.752 3.752 0 0118 19.5H6.75z"/>
        </g>
        
        <g *ngSwitchCase="'arrow-down-tray'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3"/>
        </g>
        
        <!-- Action Icons -->
        <g *ngSwitchCase="'arrow-path'">
        ...
        <g *ngSwitchCase="'ellipsis-vertical'">
        ...
        <g *ngSwitchCase="'light-bulb'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75-7.478v-.353a6 6 0 00-3.75-5.576"/>
        </g>
        ...
        <g *ngSwitchCase="'calculator'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.75 15.75V18m-7.5-6.75h.008v.008H8.25v-.008zm0 2.25h.008v.008H8.25V13.5zm0 2.25h.008v.008H8.25v-.008zm0 2.25h.008V18H8.25v-.008zM12.75 13.5h.008v.008h-.008V13.5zm0 2.25h.008v.008h-.008V15.75zm0 2.25h.008V18h-.008v-.008zM9.75 9.75V12h4.5V9.75H9.75z M5.25 18.75h13.5A2.25 2.25 0 0021 16.5V5.25A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25v11.25A2.25 2.25 0 005.25 18.75z"/>
        </g>
        ...
        <!-- Additional Fintech Icons -->
        <g *ngSwitchCase="'magnifying-glass'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z"/>
        </g>
        
        <g *ngSwitchCase="'funnel'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3c7.2 0 9 1.8 9 9s-1.8 9-9 9-9-1.8-9-9 1.8-9 9-9zM8 10l4 4 4-4"/>
        </g>
        
        <g *ngSwitchCase="'building-office'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.25 21h19.5m-18-18v18m2.25-18v18m13.5-18v18M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12m-.75 4.5H21m-3.75 3.75h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008zm0 3h.008v.008h-.008v-.008z"/>
        </g>
        ...
        <g *ngSwitchCase="'calendar-days'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5a2.25 2.25 0 002.25-2.25m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5a2.25 2.25 0 012.25 2.25v7.5M9 12.75h.008v.008H9V12.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm2.25 0h.008v.008H11.25V12.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm2.25 0h.008v.008h-.008V12.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"/>
        </g>
        
        <g *ngSwitchCase="'bars-arrow-down'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4.5h12.75m-12.75 5.25h12.75m-12.75 5.25H16.5m4.5-7.5L18 10.5m0 0L15 7.5m3 3v6"/>
        </g>
        
        <g *ngSwitchCase="'document-magnifying-glass'">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m6.75 12H9m1.5-12H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9zm3.75 11.625a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z"/>
        </g>
        
        <g *ngSwitchCase="'check-badge'">
        ...
        <g *ngSwitchDefault>
          ...
          <path d="M8 12h8m-4-4v8" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
        </g>
      </ng-container>
    </svg>
  `,
